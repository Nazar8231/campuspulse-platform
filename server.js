...
function generateRecommendations(stats) {
  ...
  if (stats.averageSleep < 7) {
    tips.push('Сон нижче рекомендованого рівня. Спробуйте стабілізувати час відходу до сну та зменшити роботу ввечері.');
  }
  ...
  if (stats.averageWorkload >= 7) {
    tips.push('Навчальне навантаження високе. Спробуйте пріоритизувати задачі та розбивати їх на менші кроки.');
  }
